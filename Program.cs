        ...
        static void Main(string[] args)
        {
            ...
            ");
                ...
                List<Accomplice> accomplices = new List<Accomplice>() {};
                    ...
                    /*
                    Loops through the user prompts for the user to add multiple team members' names, skill levels, and courage factors. 
                    Ends the loop when the user enters a blank response for a team member's name
                    */
                    while(true)
                    {
                ...
                /*
                Loops through the heist scenarios evaluating whether the team's total skill value is higher than the combined bank difficulty and luck factor value. 
                Ends the loop when the number of calculated heist scenarios matches the number of trials the user prescribed
                */
                while(trial < scenarios)
                {
                    ...
                    //Inializes the LuckyBankDifficultyValue to the value generated by adding the user prescribed bank difficulty value with the LuckValue
                    ...
                    /*
                    Calculates a single heist scenario. 
                    If the combined value of the team members' SkillLevel are greater than the combined bank difficulty and luck values then the heist returns as a success.
                    If the combined value of the team members' SkillLevel are less than the combined bank difficulty and luck values then the heist returns as a failure.
                    */
                ...
                //Displays the total number of heist scenarios calculated as being successful as well as the total number calculated as being failures
